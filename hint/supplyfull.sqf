...
_text1  = "<t color='#ffffff' size='1' shadow='1' shadowColor='#000000' align='Center'>Reached HQ area<br/></t>";
_text2  = "<t color='#ffffff' size='1' shadow='1' shadowColor='#000000' align='Center'>Supply truck is<br/></t>";
_text3  = "<t color='#FFD700' size='1.5' shadow='1.5' shadowColor='#000000' align='center'><br/>Fully LOADED</t><br/><br/>";
