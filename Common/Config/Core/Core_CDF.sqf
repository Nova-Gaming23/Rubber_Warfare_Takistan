...
_i = _i + [['','',2000,18,-2,0,1,0,'CDF',[]]];

_c = _c + ['UralRepair_CDF'];
_i = _i + [['','',15000,21,-2,2,1,0,'CDF',[]]];

//_c = _c + ['UralReammo_CDF'];
//_i = _i + [['','',5000,21,-2,1,1,0,'CDF',[]]];

_c = _c + ['UralRefuel_CDF'];
_i = _i + [['','',10000,21,-2,1,1,0,'CDF',[]]];

_c = _c + ['WarfareSupplyTruck_CDF'];
_i = _i + [['','',1500,21,-2,0,1,0,'CDF',[]]];
...
_c = _c + ['GRAD_CDF'];
_i = _i + [['','',85000,35,-2,3,1,0,'CDF',[]]];

/* Heavy Vehicles */
_c = _c + ['BMP2_Ambul_CDF'];
_i = _i + [['','',15000,20,-2,0,2,0,'CDF',[]]];

_c = _c + ['BMP2_CDF'];
_i = _i + [['','',2600,30,-2,1,2,0,'CDF',[]]];

_c = _c + ['T72_CDF'];
_i = _i + [['','',5250,35,-2,3,2,0,'CDF',[]]];

/* Air Vehicles */
_c = _c + ['Mi17_CDF'];
_i = _i + [['','',9000,35,-2,0,3,0,'CDF',[]]];

_c = _c + ['Mi17_medevac_CDF'];
_i = _i + [['','',18000,35,-2,1,3,0,'CDF',[]]];

_c = _c + ['Mi24_D'];
_i = _i + [['','',20000,40,-2,2,3,0,'CDF',[]]];

_c = _c + ['Su25_CDF'];
_i = _i + [['','',34000,55,-2,3,3,0,'CDF',[]]];

/* Static Defenses */
_c = _c + ['CDF_WarfareBMGNest_PK'];
_i = _i + [['','',600,0,1,0,'Defense',0,'CDF',[]]];

_c = _c + ['DSHkM_Mini_TriPod_CDF'];
_i = _i + [['','',400,0,1,0,'Defense',0,'CDF',[]]];

_c = _c + ['DSHKM_CDF'];
_i = _i + [['','',425,0,1,0,'Defense',0,'CDF',[]]];
...
_c = _c + ['SPG9_CDF'];
_i = _i + [['','',1575,0,1,0,'Defense',0,'CDF',[]]];

_c = _c + ['ZU23_CDF'];
_i = _i + [['','',6000,0,1,0,'Defense',0,'CDF',[]]];

_c = _c + ['2b14_82mm_CDF'];
_i = _i + [['Podnos 2B14','',30000,0,1,0,'Defense',0,'CDF',[]]];

_c = _c + ['D30_CDF'];
_i = _i + [['','',60250,0,1,0,'Defense',0,'CDF',[]]];
