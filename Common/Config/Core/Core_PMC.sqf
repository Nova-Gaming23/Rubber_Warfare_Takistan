...
_i = _i + [['','',1700,6,-1,2,0,0.92,'PMC',[]]];

_c = _c + ['Soldier_AT_PMC'];
_i = _i + [['','',1260,6,-1,0,0,0.90,'PMC',[]]];

_c = _c + ['Soldier_Bodyguard_AA12_PMC'];
_i = _i + [['','',425,6,-1,3,0,0.94,'PMC',[]]];

_c = _c + ['Soldier_Bodyguard_M4_PMC'];
_i = _i + [['','',325,6,-1,0,0,0.94,'PMC',[]]];

_c = _c + ['Soldier_Crew_PMC'];
_i = _i + [['','',270,6,-1,0,0,0.89,'PMC',[]]];

_c = _c + ['Soldier_Engineer_PMC'];
_i = _i + [['','',370,6,-1,2,0,0.91,'PMC',[]]];

_c = _c + ['Soldier_GL_M16A2_PMC'];
_i = _i + [['','',285,6,-1,0,0,0.92,'PMC',[]]];

_c = _c + ['Soldier_GL_PMC'];
_i = _i + [['','',360,6,-1,2,0,0.92,'PMC',[]]];

_c = _c + ['Soldier_M4A3_PMC'];
_i = _i + [['','',310,6,-1,1,0,0.91,'PMC',[]]];

_c = _c + ['Soldier_Medic_PMC'];
_i = _i + [['','',355,6,-1,2,0,0.92,'PMC',[]]];

_c = _c + ['Soldier_MG_PKM_PMC'];
_i = _i + [['','',390,6,-1,0,0,0.90,'PMC',[]]];

_c = _c + ['Soldier_MG_PMC'];
_i = _i + [['','',360,6,-1,3,0,0.92,'PMC',[]]];

_c = _c + ['Soldier_Pilot_PMC'];
_i = _i + [['','',275,6,-1,0,0,0.90,'PMC',[]]];

_c = _c + ['Soldier_PMC'];
_i = _i + [['','',330,6,-1,0,0,0.91,'PMC',[]]];

_c = _c + ['Soldier_Sniper_KSVK_PMC'];
_i = _i + [['','',490,6,-1,0,0,0.94,'PMC',[]]];

_c = _c + ['Soldier_Sniper_PMC'];
_i = _i + [['','',455,6,-1,0,0,0.94,'PMC',[]]];

_c = _c + ['Soldier_TL_PMC'];
_i = _i + [['','',1000,6,-1,0,0,0.95,'PMC',[]]];

/* Light Vehicles */
_c = _c + ['SUV_PMC'];
_i = _i + [['','',500,20,-2,0,1,0,'PMC',[]]];

_c = _c + ['ArmoredSUV_PMC'];
_i = _i + [['','',1850,25,-2,0,1,0,'PMC',[]]];

/* Air Vehicles */
_c = _c + ['Ka137_PMC'];
_i = _i + [['','',4000,35,-2,0,3,0,'PMC',[]]];

_c = _c + ['Ka137_MG_PMC'];
_i = _i + [['','',4500,35,-2,0,3,0,'PMC',[]]];

_c = _c + ['Ka60_PMC'];
_i = _i + [['','',7000,43,-2,0,3,0,'PMC',[]]];

_c = _c + ['Ka60_GL_PMC'];
_i = _i + [['','',7500,45,-2,0,3,0,'PMC',[]]];
