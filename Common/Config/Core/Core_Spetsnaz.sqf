...
/* Infantry */
_c = _c + ['RUS_Soldier1'];
_i = _i + [['','',300,6,-1,2,0,0.98,'Russians Spetsnaz',[]]];

_c = _c + ['RUS_Soldier2'];
_i = _i + [['','',320,6,-1,3,0,0.98,'Russians Spetsnaz',[]]];

_c = _c + ['RUS_Soldier_GL'];
_i = _i + [['','',970,6,-1,3,0,0.99,'Russians Spetsnaz',[]]];

_c = _c + ['RUS_Soldier_Marksman'];
_i = _i + [['','',390,6,-1,3,0,0.99,'Russians Spetsnaz',[]]];

_c = _c + ['RUS_Soldier3'];
_i = _i + [['','',395,6,-1,3,0,0.98,'Russians Spetsnaz',[]]];

_c = _c + ['RUS_Soldier_TL'];
_i = _i + [['','',500,6,-1,3,0,1.0,'Russians Spetsnaz',[]]];
