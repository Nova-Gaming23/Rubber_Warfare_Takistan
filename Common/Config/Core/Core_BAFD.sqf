...
_i = _i + [['','',2850,6,-1,2,0,0.88,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_AAA_DDPM'];
_i = _i + [['','',840,6,-1,2,0,0.87,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_AAT_DDPM'];
_i = _i + [['','',890,4,-1,2,0,0.84,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_AHAT_DDPM'];
_i = _i + [['','',890,6,-1,3,0,0.90,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_AAR_DDPM'];
_i = _i + [['','',190,5,-1,2,0,0.93,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_AMG_DDPM'];
_i = _i + [['','',190,6,-1,1,0,0.92,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_AT_DDPM'];
_i = _i + [['','',1836,6,-1,2,0,0.92,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_HAT_DDPM'];
_i = _i + [['','',2800,6,-1,3,0,0.94,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_AR_DDPM'];
_i = _i + [['','',210,5,-1,2,0,0.90,'British (Desert)',[]]];

_c = _c + ['BAF_crewman_DDPM'];
_i = _i + [['','',125,5,-1,1,0,0.88,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_EN_DDPM'];
_i = _i + [['','',1050,5,-1,1,0,0.89,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_GL_DDPM'];
_i = _i + [['','',170,5,-1,1,0,0.89,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_FAC_DDPM'];
_i = _i + [['','',1250,6,-1,3,0,0.98,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_MG_DDPM'];
_i = _i + [['','',310,5,-1,1,0,0.90,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_scout_DDPM'];
_i = _i + [['','',340,6,-1,2,0,0.91,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_Marksman_DDPM'];
_i = _i + [['','',370,6,-1,3,0,0.91,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_Medic_DDPM'];
_i = _i + [['','',260,6,-1,1,0,0.91,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_Officer_DDPM'];
_i = _i + [['','',465,6,-1,2,0,0.91,'British (Desert)',[]]];

_c = _c + ['BAF_Pilot_DDPM'];
_i = _i + [['','',125,6,-1,1,0,0.89,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_DDPM'];
_i = _i + [['','',155,6,-1,1,0,0.90,'British (Desert)',[]]];

_c = _c + ['BAF_ASoldier_DDPM'];
_i = _i + [['','',160,6,-1,1,0,0.90,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_L_DDPM'];
_i = _i + [['','',130,6,-1,1,0,0.90,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_N_DDPM'];
_i = _i + [['','',175,6,-1,1,0,0.91,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_SL_DDPM'];
_i = _i + [['','',325,6,-1,2,0,0.97,'British (Desert)',[]]];

_c = _c + ['BAF_Soldier_TL_DDPM'];
_i = _i + [['','',445,6,-1,1,0,0.97,'British (Desert)',[]]];
...
_i = _i + [['','',955,21,-2,0,1,0,'British (Desert)',[]]];

/* Heavy Vehicles */
_c = _c + ['BAF_FV510_D'];
_i = _i + [['','',7500,30,-2,2,2,0,'British (Desert)',[]]];
