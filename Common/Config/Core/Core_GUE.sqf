...
/* Infantry */
_c = _c + ['GUE_Soldier_1'];
_i = _i + [['','',250,4,-1,0,0,0.55,'Guerilla',[]]];

_c = _c + ['GUE_Soldier_2'];
_i = _i + [['','',220,4,-1,0,0,0.55,'Guerilla',[]]];

_c = _c + ['GUE_Soldier_3'];
_i = _i + [['','',240,4,-1,0,0,0.55,'Guerilla',[]]];

_c = _c + ['GUE_Soldier_GL'];
_i = _i + [['','',250,5,-1,1,0,0.55,'Guerilla',[]]];

_c = _c + ['GUE_Soldier_AT'];
_i = _i + [['','',1420,5,-1,1,0,0.58,'Guerilla',[]]];

_c = _c + ['GUE_Soldier_AA'];
_i = _i + [['','',1950,4,-1,0,0,0.59,'Guerilla',[]]];

_c = _c + ['GUE_Soldier_AR'];
_i = _i + [['','',250,4,-1,1,0,0.54,'Guerilla',[]]];

_c = _c + ['GUE_Soldier_MG'];
_i = _i + [['','',390,4,-1,0,0,0.53,'Guerilla',[]]];

_c = _c + ['GUE_Soldier_Sniper'];
_i = _i + [['','',375,6,-1,1,0,0.62,'Guerilla',[]]];

_c = _c + ['GUE_Soldier_Medic'];
_i = _i + [['','',360,6,-1,0,0,0.59,'Guerilla',[]]];

_c = _c + ['GUE_Soldier_Crew'];
_i = _i + [['','',180,5,-1,0,0,0.51,'Guerilla',[]]];

_c = _c + ['GUE_Soldier_Pilot'];
_i = _i + [['','',180,5,-1,0,0,0.52,'Guerilla',[]]];

_c = _c + ['GUE_Soldier_Scout'];
_i = _i + [['','',360,5,-1,3,0,0.63,'Guerilla',[]]];

_c = _c + ['GUE_Soldier_Sab'];
_i = _i + [['','',401,5,-1,2,0,0.64,'Guerilla',[]]];

_c = _c + ['GUE_Commander'];
_i = _i + [['','',640,5,-1,0,0,0.65,'Guerilla',[]]];
...
_c = _c + ['V3S_Gue'];
_i = _i + [['','',275,15,-2,0,1,0,'Guerilla',[]]];

_c = _c + ['Pickup_PK_GUE'];
_i = _i + [['','',350,17,-2,0,1,0,'Guerilla',[]]];

_c = _c + ['Offroad_DSHKM_Gue'];
_i = _i + [['','',400,25,-2,1,1,0,'Guerilla',[]]];

_c = _c + ['Offroad_SPG9_Gue'];
_i = _i + [['','',480,20,-2,2,1,0,'Guerilla',[]]];

_c = _c + ['BRDM2_Gue'];
_i = _i + [['','',1300,25,-2,2,1,0,'Guerilla',[]]];

_c = _c + ['Ural_ZU23_Gue'];
_i = _i + [['','',3950,25,-2,3,1,0,'Guerilla',[]]];

/* Heavy Vehicles */
_c = _c + ['BMP2_Gue'];
_i = _i + [['','',3900,30,-2,0,2,0,'Guerilla',[]]];

_c = _c + ['T72_Gue'];
_i = _i + [['','',7200,35,-2,2,2,0,'Guerilla',[]]];
...
_c = _c + ['DSHKM_Gue'];
_i = _i + [['','',425,0,1,0,'Defense',0,'Guerilla',[]]];

_c = _c + ['SPG9_Gue'];
_i = _i + [['','',5275,0,1,0,'Defense',0,'Guerilla',[]]];

_c = _c + ['ZU23_Gue'];
_i = _i + [['','',6000,0,1,0,'Defense',0,'Guerilla',[]]];
