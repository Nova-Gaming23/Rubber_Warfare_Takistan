...
_i = _i + [['','',585,6,-1,3,0,0.89,'US',[]]];

_c = _c + ['US_Soldier_AAT_EP1'];
_i = _i + [['','',420,6,-1,3,0,0.88,'US',[]]];
...
_i = _i + [['','',900,20,-2,1,1,0,'US',[]]];

_c = _c + ['HMMWV_M1151_M2_DES_EP1'];
_i = _i + [['','',1050,20,-2,1,1,0,'US',[]]];

_c = _c + ['HMMWV_M998_crows_M2_DES_EP1'];
_i = _i + [['','',1550,22,-2,1,1,0,'US',[]]];

_c = _c + ['HMMWV_M998_crows_MK19_DES_EP1'];
_i = _i + [['','',1675,22,-2,1,1,0,'US',[]]];

_c = _c + ['HMMWV_TOW_DES_EP1'];
_i = _i + [['','',3850,20,-2,2,1,0,'US',[]]];

_c = _c + ['HMMWV_Avenger_DES_EP1'];
_i = _i + [['','',8000,25,-2,3,1,0,'US',[]]];

_c = _c + ['HMMWV_Ambulance_DES_EP1'];
_i = _i + [['','',10000,22,-2,2,1,0,'US',[]]];

_c = _c + ['MTVR_DES_EP1'];
_i = _i + [['','',400,20,-2,0,1,0,'US',[]]];

_c = _c + ['MtvrRepair_DES_EP1'];
_i = _i + [['*ENGINEER Truck','',10000,22,-2,2,1,0,'US',[]]];

/*_c = _c + ['MtvrReammo_DES_EP1'];
_i = _i + [['','',5000,22,-2,1,1,0,'US',[]]];*/

_c = _c + ['MtvrRefuel_DES_EP1'];
_i = _i + [['*SERVICE Truck','',6000,22,-2,1,1,0,'US',[]]];

_c = _c + ['MtvrSupply_DES_EP1'];
_i = _i + [['*SUPPLY Truck','',6500,35,-2,0,1,0,'US',[]]];

_c = _c + ['MtvrSalvage_DES_EP1'];
_i = _i + [['*TECH MHQ REPAIR','',25000,50,-2,0,1,0,'US',[]]];

/* Heavy Vehicles */
_c = _c + ['M1126_ICV_M2_EP1'];
_i = _i + [['','',3450,25,[false,true,2,0],1,1,0,'US',[]]];

_c = _c + ['M1126_ICV_mk19_EP1'];
_i = _i + [['','',3750,25,[false,true,2,0],2,1,0,'US',[]]];

_c = _c + ['M1129_MC_EP1'];
_i = _i + [['','',28300,25,-2,1,2,0,'US',[]]];

_c = _c + ['M1135_ATGMV_EP1'];
_i = _i + [['','',4050,25,-2,3,1,0,'US',[]]];

_c = _c + ['M1128_MGS_EP1'];
_i = _i + [['','',4850,25,-2,3,1,0,'US',[]]];

_c = _c + ['M1133_MEV_EP1'];
_i = _i + [['','',14550,25,-2,0,2,0,'US',[]]];

_c = _c + ['M2A2_EP1'];
_i = _i + [['','',4450,30,-2,1,2,0,'US',[]]];

_c = _c + ['M2A3_EP1'];
_i = _i + [['','',5150,35,-2,1,2,0,'US',[]]];

_c = _c + ['M1A1_US_DES_EP1'];
_i = _i + [['','',12000,40,-2,2,2,0,'US',[]]];

_c = _c + ['MLRS_DES_EP1'];
_i = _i + [['','',70000,40,-2,3,2,0,'US',[]]];

_c = _c + ['M1A2_US_TUSK_MG_EP1'];
_i = _i + [['','',15250,50,-2,3,2,0,'US',[]]];

_c = _c + ['M6_EP1'];
_i = _i + [['','',15550,35,-2,3,2,0,'US',[]]];
...
_c = _c + ['UH60M_MEV_EP1'];
_i = _i + [['','',15000,35,-2,0,3,0,'US',[]]];

_c = _c + ['CH_47F_EP1'];
_i = _i + [['','',9000,40,-2,0,3,0,'US',[]]];

_c = _c + ['C130J_US_EP1'];
_i = _i + [['AC-130U Spooky Gunship','',19500,55,-2,1,3,0,'US',[]]];

_c = _c + ['AH6X_EP1'];
_i = _i + [['','',9500,50,-2,1,3,0,'US',[]]];

_c = _c + ['AH6J_EP1'];
_i = _i + [['','',9800,50,-2,1,3,0,'US',[]]];

_c = _c + ['AH64D_EP1'];
_i = _i + [['AH-64D Apache','',48000,60,-2,3,3,0,'US',[]]];

_c = _c + ['A10_US_EP1'];
_i = _i + [['A-10 Thunderbolt II US','',65000,65,-2,2,3,0,'US',[]]];

_c = _c + ['ZSU_CDF'];
_i = _i + [['*Rapier SAM','',40000,45,-2,3,3,0,'US',[]]];
...
_c = _c + ['Camp_EP1'];
_i = _i + [['Blufor-Respawn','',2000,0,0,0,0,0,'US',[]]];


/* Static Defenses */
_c = _c + ['WarfareBMGNest_M240_US_EP1'];
_i = _i + [['','',600,0,1,0,'Defense',0,'US',[]]];

_c = _c + ['M2HD_mini_TriPod_US_EP1'];
_i = _i + [['','',400,0,1,0,'Defense',0,'US',[]]];

_c = _c + ['M2StaticMG_US_EP1'];
_i = _i + [['','',425,0,1,0,'Defense',0,'US',[]]];
...
_i = _i + [['','',15500,0,1,0,'tow',0,'US',[]]];

_c = _c + ['Stinger_Pod_US_EP1'];
_i = _i + [['','',17500,0,1,0,'Defense',0,'US',[]]];

_c = _c + ['M252_US_EP1'];
_i = _i + [['','',30000,0,1,0,'Defense',0,'US',[]]];

_c = _c + ['M119_US_EP1'];
_i = _i + [['','',60250,0,1,0,'Defense',0,'US',[]]];

/* Defense Structures */
_c = _c + ['US_WarfareBBarrier5x_EP1'];
_i = _i + [['','',550,0,0,0,'Fortification',0,'US',[]]];

_c = _c + ['US_WarfareBBarrier10x_EP1'];
_i = _i + [['','',750,0,0,0,'Fortification',0,'US',[]]];

_c = _c + ['US_WarfareBBarrier10xTall_EP1'];
_i = _i + [['','',1000,0,0,0,'Fortification',0,'US',[]]];

_c = _c + ['Land_CamoNet_NATO_EP1'];
_i = _i + [['','',1350,0,0,0,'Strategic',0,'US',[]]];

_c = _c + ['Land_CamoNetVar_NATO_EP1'];
_i = _i + [['','',1450,0,0,0,'Strategic',0,'US',[]]];

_c = _c + ['Land_CamoNetB_NATO_EP1'];
_i = _i + [['','',2000,0,0,0,'Strategic',0,'US',[]]];

/*_c = _c + ['USOrdnanceBox_EP1'];
_i = _i + [['','',850,0,0,0,'Ammo',0,'US',[]]];

_c = _c + ['USVehicleBox_EP1'];
_i = _i + [['','',900000,0,0,0,'Ammo',0,'US',[]]];
