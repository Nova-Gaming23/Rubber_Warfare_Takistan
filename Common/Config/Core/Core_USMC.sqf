...
_c = _c + ['USMC_Soldier2'];
_i = _i + [['','',125,4,-1,0,0,0.82,'USMC',[]]];

_c = _c + ['USMC_Soldier_LAT'];
_i = _i + [['','',1025,5,-1,0,0,0.84,'USMC',[]]];

_c = _c + ['USMC_Soldier_AT'];
_i = _i + [['','',1550,5,-1,2,0,0.88,'USMC',[]]];

_c = _c + ['USMC_Soldier_HAT'];
_i = _i + [['','',2800,6,-1,3,0,0.91,'USMC',[]]];

_c = _c + ['USMC_Soldier_AA'];
_i = _i + [['','',2850,6,-1,3,0,0.89,'USMC',[]]];

_c = _c + ['USMC_Soldier_AR'];
_i = _i + [['','',210,5,-1,1,0,0.84,'USMC',[]]];

_c = _c + ['USMC_Soldier_MG'];
_i = _i + [['','',300,5,-1,1,0,0.89,'USMC',[]]];
...
_i = _i + [['','',250,4,-1,0,0,0.89,'USMC',[]]];

_c = _c + ['USMC_SoldierS_Engineer'];
_i = _i + [['','',1050,5,-1,1,0,0.86,'USMC',[]]];

_c = _c + ['USMC_SoldierS'];
_i = _i + [['','',300,7,-1,1,0,0.91,'USMC',[]]];

_c = _c + ['USMC_SoldierS_Spotter'];
_i = _i + [['','',320,6,-1,3,0,0.92,'USMC',[]]];

_c = _c + ['USMC_Soldier_Crew'];
_i = _i + [['','',120,4,-1,0,0,0.86,'USMC',[]]];

_c = _c + ['USMC_Soldier_Pilot'];
_i = _i + [['','',120,4,-1,0,0,0.87,'USMC',[]]];

_c = _c + ['USMC_Soldier_TL'];
_i = _i + [['','',240,5,-1,1,0,0.93,'USMC',[]]];
...
_c = _c + ['HMMWV_Armored'];
_i = _i + [['','',800,20,-2,1,1,0,'USMC',[]]];

_c = _c + ['HMMWV_MK19'];
_i = _i + [['','',900,22,-2,1,1,0,'USMC',[]]];

_c = _c + ['HMMWV_TOW'];
_i = _i + [['','',3750,20,-2,2,1,0,'USMC',[]]];

_c = _c + ['HMMWV_Avenger'];
_i = _i + [['','',8600,25,-2,3,1,0,'USMC',[]]];

_c = _c + ['HMMWV_Ambulance'];
_i = _i + [['','',10000,22,-2,2,1,0,'USMC',[]]];

_c = _c + ['MTVR'];
_i = _i + [['','',400,20,-2,0,1,0,'USMC',[]]];

/*_c = _c + ['WarfareSalvageTruck_USMC'];
_i = _i + [['*SALVAGE Truck','',2000,21,-2,0,1,0,'USMC',[]]];*/

_c = _c + ['MtvrRepair'];
_i = _i + [['*ENGINEERS Truck','',10000,22,-2,2,1,0,'USMC',[]]];

/*_c = _c + ['WarfareReammoTruck_USMC'];
_i = _i + [['','',5000,22,-2,1,1,0,'USMC',[]]];*/

_c = _c + ['MtvrRefuel'];
_i = _i + [['*SERVICE TRUCK','',6000,22,-2,1,1,0,'USMC',[]]];

_c = _c + ['WarfareSupplyTruck_USMC'];
_i = _i + [['*SUPPLY Truck','',6500,35,-2,0,1,0,'USMC',[]]];
...
_c = _c + ['LAV25'];
_i = _i + [['','',4000,30,-2,3,1,0,'USMC',[]]];

/* Heavy Vehicles */
_c = _c + ['AAV'];
_i = _i + [['','',3550,25,-2,0,2,0,'USMC',[]]];

_c = _c + ['M1A1'];
_i = _i + [['','',12000,40,-2,if (WF_A2_Vanilla) then {1} else {2},2,0,'USMC',[]]];

_c = _c + ['MLRS'];
_i = _i + [['','',70000,40,-2,3,2,0,'USMC',[]]];

_c = _c + ['M1A2_TUSK_MG'];
_i = _i + [['','',15250,50,-2,if (WF_A2_Vanilla) then {2} else {3},2,0,'USMC',[]]];
...
_c = _c + ['UH1Y'];
_i = _i + [['','',10040,40,-2,1,3,0,'USMC',[]]];

_c = _c + ['MV22'];
_i = _i + [['MV-22 Osprey','',11000,43,-2,0,3,0,'USMC',[]]];

_c = _c + ['C130J'];
_i = _i + [['AC-130U Spooky Gunship','',17500,52,-2,1,3,0,'USMC',[]]];

_c = _c + ['AH1Z'];
_i = _i + [['Ah-1Z Cobra','',36000,60,-2,2,2,0,'USMC',[]]];

_c = _c + ['AH64D'];
_i = _i + [['AH-64D Apache USMC','',48000,60,-2,2,3,0,'USMC',[]]];

_c = _c + ['F35B'];
_i = _i + [['F-35 Lighting II','',125000,62,-2,3,3,0,'USMC',[]]];

_c = _c + ['AV8B2'];
_i = _i + [['AV-8B Harrier','',58500,65,-2,3,3,0,'USMC',[]]];

_c = _c + ['A10'];
_i = _i + [['A-10 Thunderbolt II USMC','',65000,70,-2,2,3,0,'USMC',[]]];
...
_i = _i + [['','',600,0,1,0,'Defense',0,'USMC',[]]];

_c = _c + ['M2HD_mini_TriPod'];
_i = _i + [['','',400,0,1,0,'Defense',0,'USMC',[]]];

_c = _c + ['M2StaticMG'];
_i = _i + [['','',425,0,1,0,'Defense',0,'USMC',[]]];

_c = _c + ['SearchLight'];
_i = _i + [['','',125,0,1,0,'Defense',0,'USMC',[]]];

_c = _c + ['MK19_TriPod'];
_i = _i + [['','',900,0,1,0,'Defense',0,'USMC',[]]];

_c = _c + ['TOW_TriPod'];
_i = _i + [['','',20000,0,1,0,'Defense',0,'USMC',[]]];

_c = _c + ['Stinger_Pod'];
_i = _i + [['','',23000,0,1,0,'Defense',0,'USMC',[]]];

_c = _c + ['M252'];
_i = _i + [['','',30000,0,1,0,'Defense',0,'USMC',[]]];

_c = _c + ['M119'];
_i = _i + [['','',60250,0,1,0,'Defense',0,'USMC',[]]];

/* Defense Structures */
_c = _c + ['Land_CamoNet_NATO'];
_i = _i + [['','',1350,0,0,0,'Strategic',0,'USMC',[]]];

_c = _c + ['Land_CamoNetVar_NATO'];
_i = _i + [['','',1450,0,0,0,'Strategic',0,'USMC',[]]];

_c = _c + ['Land_CamoNetB_NATO'];
_i = _i + [['','',1550,0,0,0,'Strategic',0,'USMC',[]]];

/*_c = _c + ['USOrdnanceBox'];
_i = _i + [['','',850,0,0,0,'Ammo',0,'USMC',[]]];

_c = _c + ['USVehicleBox'];
_i = _i + [['','',900000,0,0,0,'Ammo',0,'USMC',[]]];
