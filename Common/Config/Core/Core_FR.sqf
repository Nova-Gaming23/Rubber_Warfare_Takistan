...
/* Infantry */
_c = _c + ['FR_GL'];
_i = _i + [['','',360,6,-1,2,0,0.98,'USMC Force Recon',[]]];

_c = _c + ['FR_Corpsman'];
_i = _i + [['','',370,6,-1,2,0,0.98,'USMC Force Recon',[]]];

_c = _c + ['FR_Commander'];
_i = _i + [['','',495,6,-1,2,0,1.00,'USMC Force Recon',[]]];

_c = _c + ['FR_TL'];
_i = _i + [['','',385,6,-1,2,0,1.00,'USMC Force Recon',[]]];

_c = _c + ['FR_Assault_R'];
_i = _i + [['','',380,6,-1,2,0,0.99,'USMC Force Recon',[]]];

_c = _c + ['FR_Assault_GL'];
_i = _i + [['','',385,6,-1,2,0,0.99,'USMC Force Recon',[]]];

_c = _c + ['FR_AR'];
_i = _i + [['','',390,6,-1,2,0,0.98,'USMC Force Recon',[]]];

_c = _c + ['FR_R'];
_i = _i + [['','',400,6,-1,2,0,0.98,'USMC Force Recon',[]]];

_c = _c + ['FR_Sapper'];
_i = _i + [['','',410,6,-1,2,0,0.98,'USMC Force Recon',[]]];

_c = _c + ['FR_AC'];
_i = _i + [['','',1250,6,-1,2,0,1.0,'USMC Force Recon',[]]];

_c = _c + ['FR_Marksman'];
_i = _i + [['','',440,6,-1,2,0,0.99,'USMC Force Recon',[]]];

/* Infantry - Special Characters */
_c = _c + ['FR_Cooper'];
_i = _i + [['','',501,6,-1,3,0,1.0,'USMC Force Recon',[]]];
