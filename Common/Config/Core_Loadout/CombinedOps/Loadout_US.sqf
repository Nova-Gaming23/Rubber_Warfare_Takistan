...
['WFBE_WESTDEFAULTWEAPONS',['M16A2','ItemCompass','ItemMap','ItemGPS','ItemWatch','ItemRadio','Binocular','NVGoggles'],true] Call SetNamespace;
['WFBE_WESTDEFAULTAMMO',['30Rnd_556x45_Stanag','30Rnd_556x45_Stanag','30Rnd_556x45_Stanag','30Rnd_556x45_Stanag','30Rnd_556x45_Stanag','30Rnd_556x45_Stanag','HandGrenade_West','HandGrenade_West','SmokeShell','SmokeShellBlue'],true] Call SetNamespace;
...
if (isServer) then {
	...
	//--- Upgrade 2.
	['WFBE_WESTLEADERWEAPONS21',['SCAR_L_STD_HOLO','MAAWS','Colt1911','Binocular_Vector','NVGoggles','ItemRadio','ItemMap'],true] Call SetNamespace;
