...
['WFBE_EASTDEFAULTWEAPONS',['AK_74','ItemCompass','ItemMap','ItemWatch','ItemRadio','Binocular','NVGoggles'],true] Call SetNamespace;
...
if (isServer) then {
	...
	['WFBE_EASTLEADERWEAPONS02',['AKS_74_kobra','RPG18','Makarov','Binocular','NVGoggles','ItemRadio','ItemMap'],true] Call SetNamespace;
	...
	['WFBE_EASTLEADERWEAPONS03',['PK','Makarov','Binocular','ItemRadio','NVGoggles','ItemMap'],true] Call SetNamespace;;
