...
_u = _u + ['NLAW'];
_i = _i + [['','','CfgMagazines','secondary',700,1,false,false,0,0,true]];

/* Primary Weapons - West */
_u = _u + ['BAF_AS50_scoped'];
_i = _i + [['','','CfgWeapons','',950,3,true,false,0,0,false]];

_u = _u + ['BAF_AS50_TWS'];
_i = _i + [['','','CfgWeapons','',1300,3,false,false,0,0,false]];
...
_i = _i + [['','','CfgWeapons','',500,1,false,false,0,0,false]];
...
/* Misc - West */
_u = _u + ['BAF_L109A1_HE'];
_i = _i + [['','','CfgMagazines','CfgMagazines',182,0,true,false,0,0,true]];

/* Misc - East */
_u = _u + ['BAF_ied_v1'];
_i = _i + [['','','CfgMagazines','CfgMagazines',125,0,true,false,0,0,true]];

_u = _u + ['BAF_ied_v2'];
_i = _i + [['','','CfgMagazines','CfgMagazines',135,1,true,false,0,0,true]];

_u = _u + ['BAF_ied_v3'];
_i = _i + [['','','CfgMagazines','CfgMagazines',145,2,true,false,0,0,true]];

_u = _u + ['BAF_ied_v4'];
_i = _i + [['','','CfgMagazines','CfgMagazines',155,2,true,false,0,0,true]];
