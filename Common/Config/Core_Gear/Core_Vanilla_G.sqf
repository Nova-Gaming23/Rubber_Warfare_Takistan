...
_u = _u + ['SMAW_HEAA'];
_i = _i + [['','','CfgMagazines','secondary',250,2,false,false,0,0,true]];

_u = _u + ['SMAW_HEDP'];
_i = _i + [['','','CfgMagazines','secondary',300,3,false,false,0,0,true]];

_u = _u + ['Stinger'];
_i = _i + [['','','CfgMagazines','secondary',800,2,false,false,0,0,true]];
...
_i = _i + [['','','CfgMagazines','primary',5,1,true,false,0,0,true]];
...
_u = _u + ['AT13'];
_i = _i + [['','','CfgMagazines','secondary',750,3,false,false,0,0,true]];

_u = _u + ['Igla'];
_i = _i + [['','','CfgMagazines','secondary',500,2,false,false,0,0,true]];

_u = _u + ['OG7'];
_i = _i + [['','','CfgMagazines','secondary',300,3,false,false,0,0,true]];

_u = _u + ['PG7V'];
_i = _i + [['','','CfgMagazines','secondary',85,0,true,false,0,0,true]];

_u = _u + ['PG7VR'];
_i = _i + [['','','CfgMagazines','secondary',175,2,false,false,0,0,true]];

_u = _u + ['PG7VL'];
_i = _i + [['','','CfgMagazines','secondary',100,1,true,false,0,0,true]];
...
_u = _u + ['DMR'];
_i = _i + [['','','CfgWeapons','',300,2,false,false,0,0,true]];
...
_u = _u + ['G36K'];
_i = _i + [['','','CfgWeapons','',205,2,false,false,0,0,true]];
...
_u = _u + ['M136'];
_i = _i + [['','','CfgWeapons','',350,0,true,false,0,0,false]];

_u = _u + ['SMAW'];
_i = _i + [['','','CfgWeapons','',700,2,false,false,0,0,false]];

_u = _u + ['Stinger'];
_i = _i + [['','','CfgWeapons','',1850,3,false,false,0,0,false]];
...
_u = _u + ['MetisLauncher'];
_i = _i + [['','','CfgWeapons','',1500,3,false,false,0,0,false]];

_u = _u + ['RPG7V'];
_i = _i + [['','','CfgWeapons','',400,0,true,false,0,0,false]];

_u = _u + ['RPG18'];
_i = _i + [['','','CfgWeapons','',80,0,true,false,0,0,false]];

_u = _u + ['Strela'];
_i = _i + [['','','CfgWeapons','',1400,3,false,false,0,0,false]];
...
_u = _u + ['M9'];
_i = _i + [['','','CfgWeapons','',30,0,true,false,0,0,true]];

_u = _u + ['M9SD'];
_i = _i + [['','','CfgWeapons','',35,0,true,false,0,0,true]];
