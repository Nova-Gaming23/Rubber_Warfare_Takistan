...
_u = _u + ['Javelin'];
_i = _i + [['','','CfgMagazines','secondary',900,3,false,false,0,0,true]];

_u = _u + ['M136'];
_i = _i + [['','','CfgMagazines','secondary',110,0,true,false,0,0,true]];

_u = _u + ['MAAWS_HEAT'];
_i = _i + [['','','CfgMagazines','secondary',475,3,false,false,0,0,true]];

_u = _u + ['MAAWS_HEDP'];
_i = _i + [['','','CfgMagazines','secondary',575,3,false,false,0,0,true]];
...
_u = _u + ['AT13'];
_i = _i + [['','','CfgMagazines','secondary',380,3,false,false,0,0,true]];

_u = _u + ['Dragon_EP1'];
_i = _i + [['','','CfgMagazines','secondary',95,1,false,false,0,0,true]];

_u = _u + ['Igla'];
_i = _i + [['','','CfgMagazines','secondary',500,3,false,false,0,0,true]];

_u = _u + ['OG7'];
_i = _i + [['','','CfgMagazines','secondary',95,2,false,false,0,0,true]];

_u = _u + ['PG7V'];
_i = _i + [['','','CfgMagazines','secondary',75,0,true,false,0,0,true]];

_u = _u + ['PG7VR'];
_i = _i + [['','','CfgMagazines','secondary',150,2,false,false,0,0,true]];

_u = _u + ['PG7VL'];
_i = _i + [['','','CfgMagazines','secondary',90,1,true,false,0,0,true]];

_u = _u + ['MAAWS_HEAT'];
_i = _i + [['','','CfgMagazines','secondary',375,3,false,false,0,0,true]];

_u = _u + ['RPG18'];
_i = _i + [['','','CfgMagazines','secondary',60,0,true,false,0,0,true]];

_u = _u + ['Strela'];
_i = _i + [['','','CfgMagazines','secondary',700,0,false,false,0,0,true]];
...
_u = _u + ['G36C_camo'];
_i = _i + [['','','CfgWeapons','',195,1,true,false,0,0,true]];

_u = _u + ['G36_C_SD_camo'];
_i = _i + [['','','CfgWeapons','',210,1,false,false,0,0,true]];
...
_i = _i + [['','','CfgWeapons','',195,1,true,false,0,0,false]];

_u = _u + ['M249_EP1'];
_i = _i + [['','','CfgWeapons','',255,2,true,false,0,0,false]];

_u = _u + ['M249_m145_EP1'];
_i = _i + [['','','CfgWeapons','',210,2,true,false,0,0,false]];

_u = _u + ['M249_TWS_EP1'];
_i = _i + [['','','CfgWeapons','',485,3,false,false,0,0,false]];
...
_u = _u + ['m107'];
_i = _i + [['','','CfgWeapons','',850,3,true,false,0,0,false]];

_u = _u + ['m107_TWS_EP1'];
_i = _i + [['','','CfgWeapons','',1050,3,true,false,0,0,false]];
...
_u = _u + ['M14_EP1'];
_i = _i + [['','','CfgWeapons','',190,1,true,false,0,0,true]];

_u = _u + ['M110_TWS_EP1'];
_i = _i + [['','','CfgWeapons','',550,3,false,false,0,0,true]];

_u = _u + ['M110_NVG_EP1'];
_i = _i + [['','','CfgWeapons','',450,3,false,false,0,0,true]];
...
_i = _i + [['','','CfgWeapons','',300,3,true,false,0,0,true]];

_u = _u + ['SCAR_H_CQC_CCO_SD'];
_i = _i + [['','','CfgWeapons','',350,3,true,false,0,0,true]];

_u = _u + ['SCAR_H_STD_EGLM_Spect'];
_i = _i + [['','','CfgWeapons','',380,3,true,false,0,0,true]];

_u = _u + ['SCAR_H_LNG_Sniper'];
_i = _i + [['','','CfgWeapons','',455,3,true,false,0,0,true]];

_u = _u + ['SCAR_H_LNG_Sniper_SD'];
_i = _i + [['','','CfgWeapons','',495,3,true,false,0,0,true]];

_u = _u + ['SCAR_H_STD_TWS_SD'];
_i = _i + [['','','CfgWeapons','',695,3,true,false,0,0,true]];
...
_u = _u + ['FN_FAL_ANPVS4'];
_i = _i + [['','','CfgWeapons','',340,3,true,false,0,0,true]];

_u = _u + ['LeeEnfield'];
_i = _i + [['','','CfgWeapons','',55,0,true,false,0,0,true]];
...
_u = _u + ['SVD'];
_i = _i + [['','','CfgWeapons','',200,2,true,false,0,0,true]];

_u = _u + ['SVD_des_EP1'];
_i = _i + [['','','CfgWeapons','',225,2,false,false,0,0,true]];

_u = _u + ['SVD_NSPU_EP1'];
_i = _i + [['','','CfgWeapons','',345,3,false,false,0,0,true]];
...
_u = _u + ['Javelin'];
_i = _i + [['','','CfgWeapons','',1650,3,false,false,0,0,false]];

_u = _u + ['M136'];
_i = _i + [['','','CfgWeapons','',150,0,true,false,0,0,false]];

_u = _u + ['MAAWS'];
_i = _i + [['','','CfgWeapons','',850,3,false,false,0,0,false]];

_u = _u + ['Stinger'];
_i = _i + [['','','CfgWeapons','',1950,3,false,false,0,0,false]];
...
_i = _i + [['','','CfgVehicles','',15000,2,false,false,0,0,false]];

_u = _u + ['M252_US_Bag_EP1'];
_i = _i + [['','','CfgVehicles','',28050,2,false,false,0,0,false]];

/* Secondary weapons - East */
_u = _u + ['Igla'];
_i = _i + [['','','CfgWeapons','',1850,2,false,false,0,0,false]];

_u = _u + ['M47Launcher_EP1'];
_i = _i + [['','','CfgWeapons','',275,1,false,false,0,0,false]];

_u = _u + ['MetisLauncher'];
_i = _i + [['','','CfgWeapons','',1305,3,false,false,0,0,false]];

_u = _u + ['RPG7V'];
_i = _i + [['','','CfgWeapons','',225,0,true,false,0,0,false]];
...
_u = _u + ['Strela'];
_i = _i + [['','','CfgWeapons','',1450,2,false,false,0,0,false]];
...
_i = _i + [['','','CfgVehicles','',2410,1,false,false,0,0,false]];

_u = _u + ['AGS_TK_Bag_EP1'];
_i = _i + [['','','CfgVehicles','',490,1,false,false,0,0,false]];

_u = _u + ['Metis_TK_Bag_EP1'];
_i = _i + [['','','CfgVehicles','',8500,3,false,false,0,0,false]];

_u = _u + ['2b14_82mm_TK_Bag_EP1'];
_i = _i + [['','','CfgVehicles','',25050,2,false,false,0,0,false]];
...
_i = _i + [['','','CfgWeapons','Item',500,1,true,false,0,0,true]];
...
_u = _u + ['Mine'];
_i = _i + [['','','CfgMagazines','CfgMagazines',200,0,true,false,0,0,true]];

_u = _u + ['PipeBomb'];
_i = _i + [['','','CfgMagazines','CfgMagazines',350,1,true,false,0,0,true]];

_u = _u + ['Laserdesignator'];
_i = _i + [['','','CfgWeapons','Special',1500,3,true,false,0,0,true]];
...
_u = _u + ['Cobalt_File'];
_i = _i + [['','','CfgWeapons','Item',2500,0,true,false,0,0,true]];
...
_u = _u + ['MineE'];
_i = _i + [['','','CfgMagazines','CfgMagazines',100,0,true,false,0,0,true]];
