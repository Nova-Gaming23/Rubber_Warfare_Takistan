...
//--- Service Trucks.
['WFBE_WESTSERVICETRUCKS',['MtvrRefuel','MtvrRefuel_DES_EP1'],true] Call SetNamespace;
...
if (isServer) then {
	...
	['WFBE_WESTPARACHUTELEVEL3',['US_Delta_Force_TL_EP1','US_Soldier_HAT_EP1','US_Soldier_HAT_EP1','US_Soldier_HAT_EP1','US_Delta_Force_AR_EP1','US_Delta_Force_Assault_EP1','US_Soldier_Medic_EP1','US_Delta_Force_M14_EP1','US_Soldier_AT_EP1','US_Soldier_Marksman_EP1'],true] Call SetNamespace;
	...
	//--- Starting Vehicles.
	['WFBE_WESTSTARTINGVEHICLES',if (WF_Camo) then {
		['HMMWV_Ambulance',
		['MTVR',[[
			["m16a4_acg",1],
			["M4A1_AIM_SD_CAMO",1],
			...
			["30Rnd_556x45_StanagSD",6],
			["1Rnd_HE_M203",6],
			["M136",3]
		]]]]
	} else {
		['HMMWV_Ambulance_DES_EP1',['MTVR_DES_EP1',[[
			["m16a4_acg",1],
			["M4A1_AIM_SD_CAMO",1],
			["M16A4_GL",1],
			["M4A1_AIM_CAMO",1],
	...
	['WFBE_WESTPARAVEHICARGO','MtvrRepair_DES_EP1',true] Call SetNamespace;
