...
//--- Service Trucks.
['WFBE_EASTSERVICETRUCKS',['UralRefuel_TK_EP1','KamazRefuel'],true] Call SetNamespace;
...
//--- UAV.
['WFBE_EASTUAV','MQ9PredatorB_US_EP1',true] Call SetNamespace;
...
if (isServer) then {
	...
	['WFBE_EASTPARACHUTELEVEL3',['MVD_Soldier_TL','RU_Soldier_HAT','RU_Soldier_HAT','RU_Soldier_HAT','RU_Soldier_HAT','MVD_Soldier_MG','RUS_Commander','MVD_Soldier_Sniper','RUS_Soldier_Marksman'],true] Call SetNamespace;
	...
	//--- Starting Vehicles.
	['WFBE_EASTSTARTINGVEHICLES',if (WF_Camo) then {
		['GAZ_Vodnik_MedEvac',['Kamaz',[[
			["AK_107_PSO",1],
			["AKS_74_UN_Kobra",2],
			["AK_107_GL_Kobra",1],
			["AKS_74_PSO",1],
			...
			["30Rnd_545x39_AK",18],
			["30Rnd_545x39_AKSD",12],
			["1Rnd_HE_GP25",6],
			["RPG18",2],
			["PG7VL",3]	
		]]]]
	} else {
		['GAZ_Vodnik_MedEvac',['V3S_TK_EP1',[[
			["AK_107_PSO",1],
			["AKS_74_UN_Kobra",2],
			["AK_107_GL_Kobra",1],
			["AKS_74_PSO",1],
	...
	['WFBE_EASTPARAVEHICARGO',if (WF_Camo) then {'KamazRepair'} else {'KamazRepair'},true] Call SetNamespace;
