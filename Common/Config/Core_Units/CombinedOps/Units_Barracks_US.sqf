...
//--- ACR CZ Special Forces
	_u = _u     + ['CZ_Soldier_DES_EP1'];
	_u = _u     + ['CZ_Soldier_B_DES_EP1'];
	_u = _u     + ['CZ_Soldier_AT_DES_EP1'];
	_u = _u     + ['CZ_Soldier_AMG_DES_EP1'];
	_u = _u     + ['CZ_Soldier_Sniper_EP1'];
	_u = _u     + ['CZ_Special_Forces_Scout_DES_EP1'];
	_u = _u     + ['CZ_Soldier_Pilot_EP1'];
	_u = _u     + ['CZ_Soldier_Office_DES_EP1'];
	_u = _u     + ['CZ_Soldier_SL_DES_EP1'];

/*--- MASSI RANGERS DESERT 
_u = _u + ['mas_ita_unit_des_aa'];
_u = _u + ['mas_ita_unit_des_at'];
_u = _u + ['mas_ita_unit_des_med'];
_u = _u + ['vehicle="mas_ita_unit_des_sl";	'];
_u = _u + ['vehicle="mas_ita_unit_des_dem";'];
_u = _u + ['mas_ita_unit_des_snp'];
_u = _u + ['mas_ita_unit_des_snphv'];
_u = _u + ['mas_ita_unit_des_tl'];
_u = _u + ['mas_ita_unit_des_gl'];*/
