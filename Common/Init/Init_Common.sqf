...
diag_log Format["[WFBE (INIT)][frameno:%3 | ticktime:%4] Init_Common: Starting Supply (West: %1 East: %2) - [Done]",PARM_Economy_StartingSupplyWest,PARM_Economy_StartingSupplyEast,diag_frameno,diag_tickTime];
diag_log Format["[WFBE (INIT)][frameno:%3 | ticktime:%4] Init_Common: Starting Funds (West: %1 East: %2) - [Done]",PARM_Economy_StartingFundsWest,PARM_Economy_StartingFundsEast,diag_frameno,diag_tickTime];

/* Allies */
if (('WFBE_ALLIES' Call GetNamespace) > 0) then {
	westAlliesFunds = PARM_Economy_StartingFundsWest*5;
	eastAlliesFunds = PARM_Economy_StartingFundsEast*5;
	
	diag_log Format["[WFBE (INIT)][frameno:%3 | ticktime:%4] Init_Common: Allies Starting Funds (West: %1 East: %2) - [Done]",PARM_Economy_StartingFundsWest*5,PARM_Economy_StartingFundsEast*5,diag_frameno,diag_tickTime];
};
