...
//   [["ACE_M6A1_W", "ACE_M6A1_G", "ACE_M6A1_D"], 1, "ACE_StingerLauncher_four", [8,0], [8,0], 0, 0, 0, [0,-1,0,2], mando_missile_path+"huds\mando_hud_avenger.sqf", 0, 0, [[-1,"ACE_StingerLauncher_four"]], 2] execVm"mando_missiles\units\mando_assignvehicle_by_type.sqf";
