...
// Typhoon
   [["rksl_efa_base"], 0, "", [4,6], [4,6], 15, 15, 20, [4,3,-0.5], mando_missile_path+"huds\mando_hud_RKSL_Typhoon.sqf", 0, 0.02, [[-6,"GLT_SidewinderXLauncher"],[-8,"GLT_AIM120Launcher"],[-7,"GLT_AIM7Launcher"]], 0]execVm"mando_missiles\units\mando_assignvehicle_by_type.sqf";
