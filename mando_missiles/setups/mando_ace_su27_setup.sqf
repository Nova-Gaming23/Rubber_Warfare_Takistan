...
[]spawn
{
   ...
   _weapon_idx = "ACE_Kh25Launcher";
   _mcc_tv_script = mando_missile_path+"tv\tv_types\mando_tv_ch25ml.sqs";
   // Pilots camera
   [["ACE_Su30","ACE_Su30_Des","ACE_Su34","ACE_Su34_MR","ACE_Su34_Des","ACE_Su34_MR_Des"], 0, 0, ["Vehicles", "REMOTE"], "MMA Kh25ML Camera", _mcc_tv_script, _launch_pos, _cam_pos_angles, {(((driver _plane == player) && !(isPlayer gunner _plane)) || (gunner _plane == player)) && ("ACE_Kh25Launcher" in weapons _plane)}, 0, _weapon_idx, _background_mfd, 1, -3]execVM"mando_missiles\mcc\mando_mccallow_by_type.sqf";
