...
// A129 cameras setup (8 onboard hellfires)
   ...
   [["ASZ_A129_GA","ASZ_A129_AT","ASZ_A129_AA"], 0, 0, ["Vehicles", "REMOTE"], "MMA Hellfire Camera", _mcctypeaascript, _launch_pos, _cam_pos_angles, {((gunner _plane == player) || ((driver _plane == player) && !(isPlayer gunner _plane))) && ("HellfireLauncher" in weapons _plane)}, 0, _weapon_idx, _background_mfd, 1, -3]execVM"mando_missiles\mcc\mando_mccallow_by_type.sqf";
