// Hud modes setup
   ...
   mando_missileidxbase = mando_missileidxbase + [[-1,"ATOW_BombLauncherA10","cwr2_BombLauncher"]];
   ...
   // Missile parameters for cwr Maverick 
   mando_hud_misp = mando_hud_misp + [[
   vehicle player,
   "",
   [0,0,0],
   ...
   mando_missileidxbase = mando_missileidxbase + [[-1,"cwr2_MaverickLauncher"]];
