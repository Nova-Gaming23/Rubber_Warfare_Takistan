...
#define WFBE_EOGS_SRVBBar 					{0.9588, 0.7137, 1, 1}
#define WFBE_EOGS_SLVLBar 					{0.9588, 0.7137, 1, 1}


//---Coloration
#define WFBE_Background_Color 				{0, 0, 0, 0.7}
#define WFBE_Background_Color_Header 		{0, 0, 0, 0.9}
#define WFBE_Background_Color_Footer 		{0.7, 0.7, 0.7, 0.7}
#define WFBE_Background_Color_Gear 			{0.5, 0.5, 0.5, 0.15}
#define WFBE_Background_Border 				{1, 1, 1, 1}
//---Thick
