...
class asr_ai {
	...
	class sys_airearming {
		...
		run = 0;          // Enable rearming at mission start
		radius = 20;      // Rearming search radius - how far will AI go to grab stuff
	...
	class sys_aiskill {
		...
		buildingSearching = 1;       // Chance the AI group will search nearby buildings when in combat mode (0 to 1 values, 0 will disable the feature)
		buildingSearchingAlwaysUp = 0; // Force UP stance (value: 1, default) when doing the house search or let AI choose automatically (value: 0)
		...
		split_legged = 120;            // Units unable to walk for this time will separate from their group to prevent slowing it down (time in seconds, set 0 to disable)
		...
		*/
		class sets {
			...
			class level_1 { // sf 1
				aimingAccuracy[] = {0.34, 0.05}; // skilltype = {<min value>, <random value added to min>};
				aimingShake[]    = {0.40, 0.20};
				aimingSpeed[]    = {0.75, 0.05};
				spotDistance[]   = {0.85, 0.07};
				spotTime[]       = {0.80, 0.20};
				endurance[]      = {0.80, 0.20};
				courage[]        = {0.80, 0.20};
			...
			class level_2 { // sf 2
				aimingAccuracy[] = {0.33, 0.05};
				aimingShake[]    = {0.47, 0.15};
				aimingSpeed[]    = {0.70, 0.05};
				spotDistance[]   = {0.80, 0.10};
				spotTime[]       = {0.70, 0.10};
				endurance[]      = {0.70, 0.20};
				courage[]        = {0.70, 0.20};
			...
			class level_3 { // regular 1
				...
				aimingShake[]    = {0.40, 0.20};
				aimingSpeed[]    = {0.65, 0.05};
				spotDistance[]   = {0.75, 0.10};
				spotTime[]       = {0.60, 0.20};
				endurance[]      = {0.60, 0.20};
				courage[]        = {0.60, 0.20};
			...
			class level_5 { // militia or trained insurgents, former regulars
				aimingAccuracy[] = {0.28, 0.05};
				aimingShake[]    = {0.40, 0.15};
				aimingSpeed[]    = {0.55, 0.05};
				spotDistance[]   = {0.75, 0.10};
				spotTime[]       = {0.54, 0.20};
				endurance[]      = {0.40, 0.20};
				courage[]        = {0.40, 0.20};
			...
			class level_6 { // civilians with some military training
				aimingAccuracy[] = {0.22, 0.07};
				aimingShake[]    = {0.40, 0.10};
				aimingSpeed[]    = {0.50, 0.05};
				spotDistance[]   = {0.74, 0.10};
				spotTime[]       = {0.50, 0.20};
				endurance[]      = {0.30, 0.20};
				courage[]        = {0.30, 0.20};
			...
			class level_7 { // civilians without military training
				...
				endurance[]      = {0.25, 0.20};
				courage[]        = {0.25, 0.20};
				reloadSpeed[]    = {0.25, 0.20};
				commanding[]     = {0.25, 0.20};
				general[]        = {0.60, 0.20};
			...
			class level_10 { // sniper
				aimingAccuracy[] = {0.60, 0.20};
				aimingShake[]    = {0.70, 0.20};
				aimingSpeed[]    = {0.50, 0.10};
				spotDistance[]   = {0.95, 0.05};
				spotTime[]       = {0.75, 0.20};
				endurance[]      = {0.70, 0.20};
				courage[]        = {0.50, 0.20};
				reloadSpeed[]    = {0.70, 0.20};
