...
//  onLoad = "with uiNameSpace do {mandotarget_disp = (_this select 0); (mandotarget_disp displayCtrl 102) ctrlSetText (mando_missile_path + ""mandotarget_circle.paa"");(mandotarget_disp displayCtrl 107) ctrlSetText (mando_missile_path +""mandotarget_cross.paa"");}";
  ...
  class controls 
  {
	...
	class MANDOTARGET_CUSTOMLINE15 : RscMandLine
	{
		idc = 45;
	};
	class MANDOTARGET_CUSTOMLINE16 : RscMandLine
	{
		idc = 46;
	};
	class MANDOTARGET_CUSTOMLINE17 : RscMandLine
	{
		idc = 47;
	};
	class MANDOTARGET_CUSTOMLINE18 : RscMandLine
	{
		idc = 48;
	};
	class MANDOTARGET_CUSTOMLINE19 : RscMandLine
	{
		idc = 49;
	};
