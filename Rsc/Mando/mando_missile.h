...
class DlgMissileKeys
{
  ...
  objects[] = { };
  controls[] = {MISKEY_OK, MISKEY_REPEAT, MISKEY_CANCEL, MISKEY_RestoreDefault};
  ...
  class MISKEY_RestoreDefault : RscMandButton
  {
  	idc = MISKEY_RestoreDefault;
  	//x = 0.5-0.105+0.005+0.068*2;
  	//y = 0.5-0.105+0.032*7;
	 x = 0.5-0.142+0.01;
	 y = 0.5-0.142+0.01;
	...
	action =  "[""RestoreDefault"", []] call mando_keyconfighandlerfunc";
  };
};
...
#include "includes\mando_waypoints.h"