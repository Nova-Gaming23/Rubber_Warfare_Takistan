...
if (!_skip) then {
	...
	_tent addAction ["<t color='#dc143c'>Undeploy Respawn</t>", "Client\Module\Skill\Actions\Officer_Undeploy_MASH.sqf", [], 75, false, true, "", "alive _target && time - WFBE_SK_V_LastUse_MASH > 10 && (isPlayer _this)"];
};