...
while {alive player && dialog} do {
	...
	if (displayUpgrade != "") then {
		...
		if (_level != _maxLevel) then {
			...
			_tooltip_text_content = parsetext (
				...
				_supplyCd +
				Format ["<t size='0.8' color='#bfbfbf' font='Zeppelin33'>%1</t><br />",Format [localize 'STR_WF_UPGRADE_Cost',"<t color=" + _colorFunds + ">" + str(_requiredFunds) + '</t>' + '/' + "<t color='#90ee90'>" + str(_currentFunds) + '</t> $']] +
	...
	switch (_levelB) do {
	case 1 : { _imgB ctrlSetText "Client\Images\upglevel1.paa";};
	case 2 : { _imgB ctrlSetText "Client\Images\upglevel2.paa";};
	case 3 : { _imgB ctrlSetText "Client\Images\upglevel3.paa";};
	};
	switch (_levelLF) do {
	case 1 : { _imgLF ctrlSetText "Client\Images\upglevel1.paa";};
	case 2 : { _imgLF ctrlSetText "Client\Images\upglevel2.paa";};
	case 3 : { _imgLF ctrlSetText "Client\Images\upglevel3.paa";};
	};
	switch (_levelHF) do {
	case 1 : { _imgHF ctrlSetText "Client\Images\upglevel1.paa";};
	case 2 : { _imgHF ctrlSetText "Client\Images\upglevel2.paa";};
	case 3 : { _imgHF ctrlSetText "Client\Images\upglevel3.paa";};
	};
	switch (_levelAF) do {
	case 1 : { _imgAF ctrlSetText "Client\Images\upglevel1.paa";};
	case 2 : { _imgAF ctrlSetText "Client\Images\upglevel2.paa";};
	case 3 : { _imgAF ctrlSetText "Client\Images\upglevel3.paa";};
	};
	sleep 0.05;
